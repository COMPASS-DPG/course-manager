...
import {
  AddCourseDto,
  AddCourseResponseDto,
} from "src/course/dto/add-course.dto";
...
export class ProviderController {
  ...
  async createAccount(@Body() signupDto: SignupDto, @Res() res) {
    try {
  ...
  async login(@Body() loginDto: LoginDto, @Res() res) {
    try {
      ...
      const providerId = await this.providerService.getProviderIdFromLogin(
        loginDto
      );
  ...
  async updateProfile(
    ...
    try {
      ...
      await this.providerService.updateProfileInfo(
        providerId,
        updateProfileDto
      );
  ...
  async editCourse(
    ...
    try {
      ...
      await this.providerService.editCourse(
        providerId,
        courseId,
        editCourseDto
      );
  ...
  async addCourse(
    ...
    try {
      ...
      const course = await this.providerService.addNewCourse(
        providerId,
        addCourseDto
      );
  ...
  @ApiOperation({
    summary: "View Course Feedback & ratings, numberOfPurchases",
  })
  ...
  async getCourseFeedback(
    ...
    try {
      ...
      const feedbackResponse = await this.providerService.getCourseFeedbacks(
        providerId,
        courseId
      );
  ...
  async getCourseTransactions(
    ...
    try {
      ...
      const transactionsResponse =
        await this.providerService.getCourseTransactions(providerId);
  ...
  async markCourseComplete(
    ...
    try {
      ...
      await this.providerService.markCourseComplete(
        providerId,
        completeCourseDto
      );
